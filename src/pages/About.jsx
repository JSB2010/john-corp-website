      ...
      <div className="container py-16 px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
            ...
            <h3 className="mb-2" style={{ fontSize: '1.25rem' }}>John Cunningham</h3>
          ...
          <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
            ...
            <h3 className="mb-2" style={{ fontSize: '1.25rem' }}>Jacob Barkin</h3>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <h3 className="mb-2" style={{ fontSize: '1.25rem' }}>Jonah Wimer</h3>
            <p className="text-blue-700 mb-3">Head Chemist and Product Lead</p>
            <p className="text-gray-700">
